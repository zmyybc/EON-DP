...
#POTENTIALS += "+PYAMFF"
CXXFLAGS = -I${dp_root}/include -I${tf_root}/tensorflow/tf/include -Wall
LDFLAGS = -L${dp_root}/lib -L${tf_root}/tensorflow/tf/lib 
#LDFLAGS += 
LDLIBS = -ldeepmd_cc -ltensorflow_cc -lstdc++ -Wl,-rpath=${dp_root}/lib -Wl,-rpath=${tf_root}/tensorflow/tf/lib
...
#Optional potentials
ifdef DEEP_POT
  CXXFLAGS += -DDEEP_POT -I${dp_root}/include -I${tf_root}/tensorflow/tf/include -Wall
  LDFLAGS += -L${dp_root}/lib -L${tf_root}/tensorflow/tf/lib 
  LDLIBS = -ldeepmd_cc -ltensorflow_cc -lstdc++ -Wl,-rpath=${dp_root}/lib -Wl,-rpath=${tf_root}/tensorflow/tf/lib
  POTDIRS += /home/jiaao/yinbc/eon/client/potentials/DEEPMD/
  LIBS += /home/jiaao/yinbc/eon/client/potentials/DEEPMD/libDeepmd.so
  POTENTIALS += "+DEEPMD "
else
   OPOTDIRS += ./potentials/DEEPMD
   POTENTIALS += "-Deepmd"
endif
...
eonclient: $(OBJECTS) $(LIBS)
	$(CXX) -o $(TARGET_NAME) $^ $(LDFLAGS) $(LDLIBS)
